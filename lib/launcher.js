...
var Launcher = function(emitter, injector) {
  ...
  this.launch = function(names, hostname, port, capturePort, urlRoot) {
    capturePort = capturePort || port;
  ...
  this.launch.$inject = ['config.browsers', 'config.hostname', 'config.port', 'config.capturePort',
      'config.urlRoot'];
